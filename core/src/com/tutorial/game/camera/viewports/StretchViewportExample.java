...
public class StretchViewportExample extends ApplicationAdapter {
    private PerspectiveCamera camera;
    //Uses the StretchViewport.
    ...
    public void create() {
        ...
        stretchViewport = new StretchViewport(Gdx.graphics.getWidth(),Gdx.graphics.getHeight(),camera);
